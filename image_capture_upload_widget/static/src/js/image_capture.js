 ...
 static template = "CaptureImage";
    ...
    async OnClickOpenCamera() {
        try {
            ...
            if (!hasWebcam) {
                this.notification.add(_t("No webcam found. Please connect a webcam to capture images."), {
                    type: "danger",
                });
                return;
            }
            ...
            this.notification.add(_t("Unable to access the webcam. Please check your device settings."), {
                type: "danger",
            });
        }
    }
    ...
    async OnClickCaptureImage() {
        ...
        context.drawImage(player, 0, 0, 270, 170);
