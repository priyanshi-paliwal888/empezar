...
export class HelpButtonUsers extends ListController {
   setup() {
       super.setup();
   }
...
registry.category("views").add("res_user_help_button", {
   ...listView,
   Controller: HelpButtonUsers,
   buttonTemplate: "res_user_help_button.ListView.Buttons",
});
