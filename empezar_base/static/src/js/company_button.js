...
export class HelpButtonCompany extends ListController {
   setup() {
       super.setup();
   }
...
registry.category("views").add("res_company_help_button", {
   ...listView,
   Controller: HelpButtonCompany,
   buttonTemplate: "res_company_help_button.ListView.Buttons",
});
