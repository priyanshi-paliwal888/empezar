...
class OdooValidator(RequestValidator):
    ...
    def _load_client(self, request, client_id=None):
        ...
        if not client:
            ...
            request.response_type = request.client.response_type
            request.client_id = request.client.identifier
    ...
    def authenticate_client(self, request, *args, **kwargs):
        ...
        return (request.client.identifier == client_id) and (request.client.secret or '') == (client_secret or '')
    ...
    def confirm_redirect_uri(
        ...
        return base_url == code.redirect_uri_id.name
    ...
    def validate_redirect_uri(self, client_id, redirect_uri, request, *args, **kwargs):
        ...
        parsed_url = urlparse(redirect_uri)
        base_url = f"{parsed_url.scheme}://{parsed_url.netloc}{parsed_url.path}"
        return request.client.identifier == client_id and base_url in request.client.mapped('redirect_uri_ids.name')
    ...
    def validate_scopes(self, client_id, scopes, client, request, *args, **kwargs):
        ...
        scopes_data = scopes
        scopes = []
        scopes_check = set(scopes).issubset(set(request.client.mapped('scope_ids.code')))
        scopes = scopes_data
        return request.client.identifier == client_id and scopes_check
        # return request.client.identifier == client_id and set(scopes).issubset(set(request.client.mapped('scope_ids.code')))
