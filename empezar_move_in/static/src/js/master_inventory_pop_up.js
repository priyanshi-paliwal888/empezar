...
patch(FormController.prototype, {
    ...
    async onRecordSaved(record) {
        if (this.props.resModel === 'move.in') {
            const recContainer = record.data.container;
                ...
                if (
                    ...
                    this.dialogService.add(ConfirmationDialog, {
                        ...
                        confirm: async () => {
                            ...
                            try {
                                await this.orm.call('move.in', 'update_container_master', [recContainer, recShippingLine,
            ...
            // Call the parent method if not in 'move.in' model
