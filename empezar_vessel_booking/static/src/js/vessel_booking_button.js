...
export class HelpButtonBooking extends ListController {
   setup() {
       super.setup();
   }
...
registry.category("views").add("vessel_booking_help_button", {
   ...listView,
   Controller: HelpButtonBooking,
   buttonTemplate: "vessel_booking_help_button.ListView.Buttons",
});
